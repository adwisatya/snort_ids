...
ACLOCAL = ${SHELL} /root/snort_ids/missing aclocal-1.13
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = ar
AUTOCONF = ${SHELL} /root/snort_ids/missing autoconf
AUTOHEADER = ${SHELL} /root/snort_ids/missing autoheader
AUTOMAKE = ${SHELL} /root/snort_ids/missing automake-1.13
AWK = gawk
CC = gcc
CCDEPMODE = depmode=gcc3
CCONFIGFLAGS =  -DSF_VISIBILITY -fvisibility=hidden
CFLAGS = -g -O2 -DSF_VISIBILITY -fvisibility=hidden -fno-strict-aliasing -Wall
CONFIGFLAGS =  -DSF_WCHAR -DTARGET_BASED -DPERF_PROFILING -DPERF_PROFILING -DSNORT_RELOAD -DNO_NON_ETHER_DECODER -DNORMALIZER -DACTIVE_RESPONSE
CPP = gcc -E
CPPFLAGS = -DGRE -DMPLS -DPPM_MGR -DNDEBUG -DSOURCEFIRE -DPPM_MGR -DENABLE_REACT -DENABLE_RESPOND -DENABLE_RESPONSE3 -DSF_WCHAR -DTARGET_BASED -DPERF_PROFILING -DPERF_PROFILING -DSNORT_RELOAD -DNO_NON_ETHER_DECODER -DNORMALIZER -DACTIVE_RESPONSE
CYGPATH_W = echo
DEFS = -DHAVE_CONFIG_H
DEPDIR = .deps
DLLTOOL = false
...
LDFLAGS =  -lpcre -L/usr/lib -ldumbnet
LEX = flex
LIBOBJS = 
LIBS = -lz -ldaq_static -ldumbnet -lpcre -lpcap -lnsl -lm -lm  -ldl -L/usr/local/lib -ldaq_static_modules  -lsfbpf -lpcap -lsfbpf -lpcap -lz -lpthread -lpthread -lpthread
...
LUA_LIBS = 
MAINT = #
MAKEINFO = ${SHELL} /root/snort_ids/missing makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
NM = /usr/bin/nm -B
NMEDIT = 
...
XCCFLAGS = 
YACC = bison -y
abs_builddir = /root/snort_ids
abs_srcdir = /root/snort_ids
abs_top_builddir = /root/snort_ids
abs_top_srcdir = /root/snort_ids
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /root/snort_ids/install-sh
